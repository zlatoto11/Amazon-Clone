...
function Login() {
  ...
  //some fancy firebasic login stuff
    ...
    <div className="login">
      ...
      <div className="login__container">
        ...
        <form>
          ...
          <input
            type="password"
            value={password} //Value in password field
            onChange={(e) => setPassword(e.target.value)} //set the password to the value of the password field. e is a generated event on change of field
          />
